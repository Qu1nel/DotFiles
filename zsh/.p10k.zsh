# Generated by Powerlevel10k configuration wizard on 2023-07-28 at 16:41 MSK.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local  untracked='%88F'   # blue foreground
  ...
  ######################################[ ram: free RAM ]#######################################
  # RAM color.
  typeset -g POWERLEVEL9K_RAM_FOREGROUND=34
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_LOAD_WHICH=48
  # Load color when load is under 50%.
  typeset -g POWERLEVEL9K_LOAD_NORMAL_FOREGROUND=82
  # Load color when load is between 50% and 70%.
  typeset -g POWERLEVEL9K_LOAD_WARNING_FOREGROUND=184
